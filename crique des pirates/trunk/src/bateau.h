/*!
  ...
  Chaque joueur étend de ce bateau
...
public:
    ...
    enum Section
   {
    ...
    /*!
      methode qui augmente la renommée du bateau
      \fn setRenommee(int renommee)
      \param nb de pt de renommée gagnés
      */
    void setRenommee(int renommee);
    /*!
      retourne la renommée gagnée lors d'une déroute
...
signals :
    ...
    /*Les signaux suivant permettent d'activer les sliders du joueurs lorsque l'on est sur l'ile.
      Ils ne sont pas mis dans la classe BateauPJ, ils ne sont pas accessible à partir de la liste joueurs de partie (BAteau)
      */
    ...
    /* Les signaux suivants seront emis lorsque l'on ne peut plus améliorer une section*/
    /*!
...
protected:
    ...
    int renommee;
    int doublon;
    int renommeeDeroute; //nbr de pt de renommée gagné lorsque l'on bat ce bateau
    int position;
