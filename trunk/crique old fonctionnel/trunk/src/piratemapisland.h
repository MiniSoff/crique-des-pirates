...
/*
  Le comportement des �les est le suivant : je clique une fois dessus, je la s�lectionne.
  Je clique � nouveau dessus, je la d�selectionne.
  Une seule �le peut-�tre s�lectionn�e � la fois (utilisation des slots et signaux).
  */
...
protected:
    ...
    // Je veux que quand on clique sur une des iles, celle-ci soit s�lectionn�e.
    // Je veux aussi que toutes les autres �les soient d�selectionn�es.
*/
